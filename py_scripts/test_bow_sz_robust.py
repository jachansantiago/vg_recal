...
test_df = pd.read_csv("../data/test_gamcompare/csv/big_bow_df_test.csv")
...
model = load_model("../data/models/bow_model_sz_robust.h5")
...
tsv.to_csv("../data/stats/test/output.tsv", index=False, sep='\t')
